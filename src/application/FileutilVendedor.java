...
public class FileutilVendedor {

	private final String ruta = "data/vendedores.txt";
	private final String separador = "$"; 

	public boolean guardar(Vendedor c) {
	...
	public List<Vendedor> leer(){
		...
		List<Vendedor> devolver = new ArrayList<Vendedor>();
		...
		try {
			...
			while (s.hasNextLine()) {
				...
				if(linea != "") {
					...
					devolver.add(new Vendedor(almacen[0], almacen[1], almacen[2] , almacen[3], almacen[4], numero, almacen[6]));
				}
			}
